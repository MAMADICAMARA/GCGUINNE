  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: DraggableScrollableSheet(
        ...
        // pos_page.dart#_showCartSheet : le bouton "Confirmer la vente" tout
        // en bas se retrouverait sous la barre de navigation système sur un
        ...
        builder: (context, scrollController) => SafeArea(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                const Text('Récapitulatif de la vente',
                    style:
                        TextStyle(fontWeight: FontWeight.w600, fontSize: 16)),
                const Text('Vérifiez avant de confirmer.',
                ...
                Expanded(
                  child: ListView(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: _LabeledValue(
                              label: 'Paiement',
                              value: _paymentLabels[widget.paymentMethod] ??
                      ...
                      _totalsRow(
                          'Réduction', '-${formatGNF(widget.discountAmount)}'),
                ...
                FilledButton(
                  onPressed: _canConfirm
                      ? () => Navigator.of(context).pop(_amountPaid)
                      : null,
    ...
    return Column(
      ...
      children: [
        Text(label.toUpperCase(),
            style: TextStyle(
                fontSize: 10, color: Colors.grey.shade500, letterSpacing: 0.5)),
        Text(value,
