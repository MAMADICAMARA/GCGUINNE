...
class MarketplaceProductDetailSheet extends StatefulWidget {
  ...
  @override
  State<MarketplaceProductDetailSheet> createState() =>
      _MarketplaceProductDetailSheetState();
}

class _MarketplaceProductDetailSheetState
    extends State<MarketplaceProductDetailSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return DraggableScrollableSheet(
      ...
      // pos_page.dart#_showCartSheet : protège la grille "Vous pourriez
      // aussi aimer" une fois défilée tout en bas.
                          ...
                          children: [
                                    ...
                                    Container(
                                      ...
                                      child: Text.rich(
                                        TextSpan(
                                          children: [
                                            TextSpan(
                                                text: '≥${tier.minQuantity}u  ',
                                                style: TextStyle(
                                                    fontSize: 12,
                                                    color:
                                                        Colors.grey.shade500)),
                                            TextSpan(
                                                text: formatGNF(tier.unitPrice),
                                                style: const TextStyle(
                                                    fontSize: 12,
                                                    fontWeight:
                                                        FontWeight.w700)),
                            ...
                            if (_product!.attributes.isNotEmpty) ...[
                              ...
                              Wrap(
                                ...
                                children: [
                                  for (final entry
                                      in _product!.attributes.entries)
                                    Container(
                                      padding: const EdgeInsets.symmetric(
                                          horizontal: 12, vertical: 8),
                                      decoration: BoxDecoration(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            color: primary),
                                        child: Text(
                                          _product!.store.name.isNotEmpty
                                              ? _product!.store.name[0]
                                                  .toUpperCase()
                                              : '?',
                                          style: const TextStyle(
                                              color: Colors.white,
                                          ...
                                          children: [
                                            Text(_product!.store.name,
                                                style: const TextStyle(
                                                    ...
                                                    fontWeight:
                                                        FontWeight.w700)),
                                            if (_product!.store.ownerName !=
                                                null)
                                              Text(_product!.store.ownerName!,
                                                  style: TextStyle(
                                                      fontSize: 11.5,
                                                      color: Colors
                                                          .grey.shade500)),
                                  ...
                                  if (isAuthenticated) ...[
                                    if (_product!.store.address != null) ...[
                                      ...
                                      _InfoRow(
                                          ...
                                          text: _product!.store.address!),
                                    ],
                                    if (_product!.store.phone != null) ...[
                                      const SizedBox(height: 8),
                                      _InfoRow(
                                          icon: Icons.phone_outlined,
                                          text: _product!.store.phone!),
                                    ],
                    ...
                    children: [
                      if (_product != null)
                        _GlassButton(
                          ...
                          onTap: () => Share.share(
                              getProductShareUrl(widget.productId),
